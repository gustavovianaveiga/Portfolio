            ...
            <div id="laptop" onClick={daynight}>
                <div id='telaecapa'>
                    <div id="tela" className='card__face'>
                        <div id="conteudo">
                            <video id='day' autoPlay muted playsinline loop>
                                <source src="https://lofi-new.s3.us-east-2.amazonaws.com/seoul/inside+-+night.mp4" type="video/mp4"></source>
                            </video>
                            <video autoPlay muted playsinline loop src="https://lofi-new.s3.us-east-2.amazonaws.com/seoul/inside+-+day.mp4" id='night' className='on' ></video>
                        </div>
                    </div>
